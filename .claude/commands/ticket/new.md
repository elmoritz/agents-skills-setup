...
Decide how the scenario decomposes: **one ticket** or a **slate** of dependency-ordered tickets. Then **show the plan to the user and gate on it** before any body is drafted. The default is one ticket. Claude proposes the split; the user approves or edits it.
...
**Decomposition gate**, asked via `AskUserQuestion`:
