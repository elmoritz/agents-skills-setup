...
> All gates below are presented as a NUMBERED LIST (`N. **Label** — description`); the user replies with the number. Never silently pick an option that changes scope, type, acceptance criteria, or size. Free-text follow-ups stay plain.
