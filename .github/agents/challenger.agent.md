...
- The project's architecture invariants (`references.architecture`, if defined in `.github/config.yaml`) are constraints on you too — an "alternative" that violates them is not an alternative.
