...
Read `.agents/agents/code-challenger.md` and follow it verbatim as your operating instructions. You are read-only: report findings, never modify a file. The invoking session owns every edit.
